...
export const FAQ_ITEMS: FaqItem[] = [
	...
	},
	{
		...
		answerLines: [
			...
			'  backend    Node.js · Hono · Express · REST',
			'  database   PostgreSQL · Drizzle ORM · Supabase · Neon',
			'  infra      Vercel · Docker · GitHub · Sentry',
			'  design     Figma · Lottie · Relume',
			'',
	...
	},
	{
		...
		answerLines: [
			...
			'',
			'  Preferred   - Telegram · Viber · email ',
			'  Response    - within 12 h on business days',
			'  First step  - text or call',
	        '',
